...
CASES = [
    ...
    ("소도시", 30, 240, "준도시"),
    ("소도시", 31, 240, "도시 외곽"), # 타운 시내도 아니고 대도시도 먼 경우만 외곽
    ("소도시", 45, 40, "준도시"),     # 대도시 통근권 교외
    ("소도시", 45, 60, "준도시"),     # Hitotsubashi: 도쿄 60분 → 준도시 (2차 수정)
    ("마을", 0, 20, "준도시"),        # Brandeis(월섬): 보스턴 20분
    ("마을", 0, 60, "준도시"),        # IE Segovia: 마드리드 60분 → 준도시 (2차 수정)
    ("마을", 0, 240, "준도시"),       # Pullman·Potsdam 등 고립 대학타운 시내 (2차 수정)
    ("마을", 0, None, "준도시"),
    ("마을", 45, 240, "도시 외곽"),   # 타운 시내조차 아닌 시골 캠퍼스
    ("마을", 45, None, "도시 외곽"),
]
